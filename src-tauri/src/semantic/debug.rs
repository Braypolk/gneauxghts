...
pub(crate) struct SemanticDebugMetrics {
    ...
    pub(crate) atlas_request_count: u64,
    pub(crate) atlas_cache_hit_count: u64,
    pub(crate) atlas_duration_total_millis: u64,
    pub(crate) atlas_duration_max_millis: u64,
    pub(crate) atlas_load_duration_total_millis: u64,
    pub(crate) atlas_load_duration_max_millis: u64,
    pub(crate) atlas_graph_duration_total_millis: u64,
    pub(crate) atlas_graph_duration_max_millis: u64,
    pub(crate) atlas_cloud_duration_total_millis: u64,
    pub(crate) atlas_cloud_duration_max_millis: u64,
    pub(crate) atlas_layout_duration_total_millis: u64,
    pub(crate) atlas_layout_duration_max_millis: u64,
    pub(crate) atlas_persist_duration_total_millis: u64,
    pub(crate) atlas_persist_duration_max_millis: u64,
    pub(crate) atlas_label_job_count: u64,
    pub(crate) atlas_label_failure_count: u64,
    pub(crate) atlas_label_candidate_total: u64,
    pub(crate) atlas_label_cache_hit_total: u64,
    pub(crate) atlas_label_provider_text_total: u64,
