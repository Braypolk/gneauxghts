...
mod tests {
    ...
    use super::{
        parse_integrate_edit_response, parse_model_json, validate_job_changes,
        validate_override_changes, AiChange, AiJobStatus, AiProviderKind, RememberMode,
        SourceSnapshot, StoredAiJob, TargetNoteContext,
    };
